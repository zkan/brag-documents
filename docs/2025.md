...
ช่วยจัดคลาส Monolith to Microservices
([Public](https://training.odds.team/events/monolith-to-microservices-by-sam-newman){target=_blank}
& Private Classes) และงาน [Platform Engineering Meetup ครั้งที่
3](https://training.odds.team/events/platform-engineering-meetup-3-sam-newman){target=_blank}
เชิญ Sam มาพูดเรื่องการพัฒนา Platform ด้วย
